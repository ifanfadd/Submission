...
# INPUT DATA
customer_df = pd.read_csv(r'C:/Users/asus/Downloads/customer_df_new.csv')
orders_df = pd.read_csv(r'C:/Users/asus/Downloads/orders_df_new.csv')
payment_df = pd.read_csv(r'C:/Users/asus/Downloads/payment_df_new.csv')
